...
void VAO::LinkAttrib(GLuint vboId, GLuint layout, GLuint numComponent, GLenum type, GLsizeiptr stride, void *offset, bool isInteger) const
{
    ...
    if (isInteger){
        glVertexAttribIPointer(layout, numComponent, type, stride, offset); 
    } else {
